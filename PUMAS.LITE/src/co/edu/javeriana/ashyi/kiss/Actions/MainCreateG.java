...
public class MainCreateG<T> extends MessagePassingAction<T>{
	
	public MainCreateG(Message mensaje) {
		super(mensaje);
	}
	...
	public T execute() {
		...
		// generateGraphPlan(datosLlegan, "Intermediary",
		// datosLlegan.getSenderAgent(), 1);
		generateGraphPlan(datos, "RepresentativeAgent", datos.getSenderAgent(), 1);
