...
public class IntermediaryInformacionSendRBackingR<T> extends MessagePassingAction<T>{
	
	public IntermediaryInformacionSendRBackingR(Message mensaje) {
		super(mensaje);
	}
	...
	public T execute() {
		...
		RepresentativeSendBackingReplyR evento = new RepresentativeSendBackingReplyR(data);
