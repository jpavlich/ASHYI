...
public class RouterReplyInformationR<T> extends MessagePassingAction<T>{
	
	public RouterReplyInformationR(Message mensaje) {
		super(mensaje);
	}
	...
	public T execute() {
		...
		System.out.println("In Guard RouterReplyInformationR");
