...
// ------- perimeter anchors -------------------    
    ...
    var _makeConnectionDrAgent = function(placeholder, _jsPlumb) {
        var stopped = false;
        return {
            drag : function() {
                if (stopped) {
...
// END TYPE
        ...
        if (jpcl.isDragSupported(_element)) {
            var placeholderInfo = { id:null, element:null },
                ...
                _drAgent = _makeConnectionDrAgent(placeholderInfo, _jsPlumb);
            ...
            dragOptions[dragEvent] = _jsPlumb.wrap(dragOptions[dragEvent], _drAgent.drag);
