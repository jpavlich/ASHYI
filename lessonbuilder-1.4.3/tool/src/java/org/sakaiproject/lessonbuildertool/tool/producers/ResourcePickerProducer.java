...
//		    return;
		...
		idTP = ((FilePickerViewParameters) viewparams).getIdItemPAshyi();
		idTU = ((FilePickerViewParameters) viewparams).getIdItemUAshyi();
		idActividad = ((FilePickerViewParameters) viewparams).getIdActividad();
		...
		else if (((FilePickerViewParameters) viewparams).getSourcePage().equalsIgnoreCase("VistaActividadProducer"))
		{
			simplePageBean.setItemPAshyi(idTP);
			simplePageBean.setItemUAshyi(idTU);
			simplePageBean.setIdActividad(idActividad);
			process = "#{simplePageBean.processStudentResponse}";
		}
		else
	...
	public List reportNavigationCases() {
		...
		params.setSourcePage("vistaActividadCloseWindow");
		...
		l.add(new NavigationCase("succesRecursoActividad", new SimpleViewParameters(RegistroRecursoProducer.VIEW_ID)));
		l.add(new NavigationCase("successStudentResponse", params));
		return l;
	}
