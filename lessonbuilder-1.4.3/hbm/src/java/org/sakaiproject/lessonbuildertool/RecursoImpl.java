...
public class RecursoImpl implements Recurso, Serializable{
	 ...
	 * @param tipo_acceso
	 */
	public RecursoImpl(String nombre, String naturaleza, String tipo, String tipo_acceso) {
		super();
		this.nombre = nombre;
		this.naturaleza = naturaleza;
		this.tipo = tipo;
	 ...
	 * @param tipo_acceso: Libre, Pago
	 */
	public RecursoImpl(String idItemSakai, String naturaleza, String tipo, String formato, String nivel, String tipo_acceso) {
		super();
		this.idItemSakai = idItemSakai;
		this.naturaleza = naturaleza;
		this.tipo = tipo;
