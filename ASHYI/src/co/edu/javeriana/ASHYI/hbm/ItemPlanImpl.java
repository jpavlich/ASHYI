...
public class ItemPlanImpl implements ItemPlan, Serializable {	
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#getIdRecurso()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setIdRecurso(co.edu.javeriana.ASHYI.model.Recurso)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#getIdActividad()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setIdActividad(co.edu.javeriana.ASHYI.model.Actividad)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#isEstaActivo()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setEstaActivo(boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#getIdItemPlan()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setIdItemPlan(java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#getOrden()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setOrden(java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#getTiempo_duracion()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setTiempo_duracion(float)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#getFecha_inicial()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setFecha_inicial(java.util.Date)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#getFecha_final()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setFecha_final(java.util.Date)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setTiempo_duracion()
	 */
...
//			this.fecha_final = date;
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setFechas(java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#getIdUnidadDidacticaPadre()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.ItemPlan#setIdUnidadDidacticaPadre(co.edu.javeriana.ASHYI.model.Actividad)
	 */
