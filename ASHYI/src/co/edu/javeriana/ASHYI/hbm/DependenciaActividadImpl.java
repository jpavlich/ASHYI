...
public class DependenciaActividadImpl implements DependenciaActividad, Serializable{
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#getOrden()
	 */
	public int getOrden() {
		return orden;
	}
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#setOrden(int)
	 */
	public void setOrden(int orden) {
		this.orden = orden;
	}
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#getIdActividad()
	 */
	public Actividad getIdActividad() {
		return idActividad;
	}
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#setIdActividad(co.edu.javeriana.ASHYI.model.Actividad)
	 */
	public void setIdActividad(Actividad idActividad) {
		this.idActividad = idActividad;
	}
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#getId_Actividad_Dependiente()
	 */
	public Actividad getId_Actividad_Dependiente() {
		return Id_Actividad_Dependiente;
	}
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#setId_Actividad_Dependiente(co.edu.javeriana.ASHYI.model.Actividad)
	 */
	public void setId_Actividad_Dependiente(Actividad id_Actividad_Dependiente) {
		Id_Actividad_Dependiente = id_Actividad_Dependiente;
	}
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#getTipoConexion()
	 */
	public int getTipoConexion() {
		return tipoConexion;
	}
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#setTipoConexion(int)
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#getIdConexion()
	 */
	...
	/* (non-Javadoc)
	 * @see co.edu.javeriana.ASHYI.model.DependenciaActividad#setIdConexion(int)
	 */
