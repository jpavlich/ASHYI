package co.edu.javeriana.ashiy.tool;
...
import co.edu.javeriana.ashiy.tool.pages.AgentPage;
...
public class MyApplication extends WebApplication {    
	...
	protected void init() {
		...
		getApplicationSettings().setPageExpiredErrorPage(AgentPage.class);
		getApplicationSettings().setAccessDeniedPage(AgentPage.class);
	 ...
	 */
	public Class<AgentPage> getHomePage() {
